...
// This is processing the audio and showing the grid
export default function GridSimulatorWAS({ audioRef }) {
    ...
    useEffect(() => {
        ...
        const animate = () => {
            ...
            // Processing what to show in the canvas
            ...
            // Calls before the next refresh for animation timing
            animationRef.current = requestAnimationFrame(animate);
        };

        // Calls before the next refresh
        animationRef.current = requestAnimationFrame(animate);
